...
public class Q1 extends MapResponseCommand {
    ...
    public List<Field> getFields() {
        return List.of(
                ...
                new Field<>("Q1 SCC PWM temperature", Integer::valueOf),
                new Field<>("Q1 Inverter temperature (AC Heatsink?)", Integer::valueOf),
                new Field<>("Q1 Battery temperature (Battery to bus inverter?)", Integer::valueOf),
                new Field<>("Q1 Transformer temperature", Integer::valueOf),
