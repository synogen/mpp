...
public class MqttUtil {
    ...
    public static HashMap<String, HomeAssistantMqttEntityBase> getHaMqttEntities(List<Field> fields, String topicPrefix, String deviceName, SerialHandler serialHandler) {
        ...
        for (var field: fields) {
            var haMqtt = switch (field.haType()) {
                ...
                case MULTIFLAG: mqttEntityList.putAll(getHaMqttEntities(field.subfields(), topicPrefix, deviceName, serialHandler)); yield null;
                case SELECT: yield new HomeAssistantMqttSelect(field, topicPrefix, deviceName, serialHandler);
